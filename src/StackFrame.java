...
public class StackFrame
{
    ...
    public StackFrame(Graphics g, int appWidth, int appHeight, int currentStackFrameCount)
    ...
    {
        this.stack = new ScaledPoint(0.10, 0.20*currentStackFrameCount, 0.40, 0.75);
        color = Color.BLACK;
